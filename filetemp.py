...
def getSubject(msg):
    ...
    if DBUG: print("getSubject: SUBJECT: " + subject)
    return subject
...
for i in range(messages, messages-N, -1):
    ...
    for response in msg:
        ...
        if isinstance(response, tuple):
            ...
            if SUBJECT.find("Telephone and Wireless Usage") > 0:
                #===============================================================================================================
                ...
                #===============================================================================================================
                # DELETE THE EMAIL IT'S NOT A PHONE VER
                print("NOT A PHONE VER EMAIL")
                #===============================================================================================================
